<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="EmployeeFamilyLogging.aspx.cs" Inherits="LoggingReport_EmployeeFamilyLogging" %>
    ...
    <table style="width:100%;margin-top:0%;vertical-align:top;">
                    ...
                    <tr>
                        <td style="width:140px;text-align:left;">
                            <asp:Label ID="lblID" Text="Unique ID:" runat="server"></asp:Label>
                        </td>
                        ...
                        <td align="left">
                            <asp:Button ID="btnSearch" Text="Search" CssClass="btn" OnClientClick="return SearchLogging();" OnClick="btnSearch_Click" runat="server" />
