...
public partial class CNICWiseReport : System.Web.UI.Page
{
    string path;
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        string result = DBCommonMethods.ExportToExcel(path, empIds, hdType.Value, fileName, hdShowFamily.Value);
        spnSearchTitle.InnerText = result;
        //hdShowFamily.Value = "";
        DownloadExcelFile();
