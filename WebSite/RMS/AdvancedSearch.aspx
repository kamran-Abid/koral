<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="AdvancedSearch.aspx.cs" Inherits="AdvancedSearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <fieldset style="width: 95%;">
        ...
        <div>
            <table id="tblNameWiseReport" class="form">

                <tr>
                    <td class="right">Enter Card/CNIC:</td>
                    <td>
                        <asp:TextBox ID="txtCNICNo"  runat="server" autocomplete="off"></asp:TextBox>
                ...
                <tr>
                    <td class="right">Enter Name:</td>
                    <td>
                        <asp:TextBox ID="txtName" class="alpha" runat="server" autocomplete="off"></asp:TextBox>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlStatus" runat="server">
                            ...
                            <asp:ListItem Value="Inactive">Inactive</asp:ListItem>
                              <asp:ListItem Value="BlackList">BlackList</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr id="trVMSVisitorDate" style="display:none;">
                    <td class="right">FROM :<span>*</span></td>
                    <td>
                        
                         <asp:TextBox ID="txtFrom"     runat="server" style="width:60%;float: left; margin-right: 5px;"></asp:TextBox>
                         <rjs:popcalendar ID="Popcalendar2" Separator="/" Format="mm dd yyyy" Control="txtFrom" runat="server"  To-Today="true"
                                Font-Names="Tahoma" />

                        <%--From-Today="true"--%>
                    </td>
                     <td class="right">TO :<span >*</span></td>
                    <td>
                        <%--CssClass="req date" --%>
                        <%--class="reqSpan"--%>
                         <asp:TextBox ID="txtTo"     runat="server" style="width:60%;float: left; margin-right: 5px;"></asp:TextBox>
                         <rjs:popcalendar ID="Popcalendar1" Separator="/" Format="mm dd yyyy" Control="txtTO" runat="server"  To-Today="true"
                                Font-Names="Tahoma" />
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
            ...
            if (Type == "4"){
                $("#trVMSVisitorDate").show();
                $("select[id$='ddlRank']").attr('disabled', true)
            }
              
            else {
                $("#trVMSVisitorDate").hide();
                $("select[id$='ddlRank']").attr('disabled', false)
            }
                
                
            $("input[id$='btnExport']").hide();
            $("input[id$='btnExport']").click(function (e) {
                //fnExportHTML("tblEmployeeDetails|tblEmployeeFamilyDetails|tblEmployeeServantDetails" + serventFamilyIDs, "#005978", "Exported Excel");
           ...
           <%-- $("input[id$='txtName']").autocomplete({
                source: function (request, response) {
                    var Name = $("input[id$='txtName']").val().trim();
                    var CNIC = $("input[id$='txtCNICNo']").val().trim();
                    var Type = $("input[id$='ddlType']").val().trim();
                    var rank = $("select[id$='ddlRank']").val().trim();
                    var status = $("select[id$='ddlStatus']").val().trim();
                    $.ajax({
                        url: '<%=ResolveUrl("~/RMS/RMSwebmethods.aspx/GetNames") %>',
                        data: "{ 'Name':'" + Name + "','Type':'" + Type + "','CNIC':'" + CNIC + "','Rank':'" + rank + "','Status':'" + status + "'}",
                        dataType: "json",
                        type: "POST",
            ...
            $("input[id$='txtCNICNo']").autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        ...
                        data: "{ 'CNIC':'" + CNIC + "','Type':'" + Type + "','Name':'" + Name + "','Rank':'" + rank + "','Status':'" + status + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
            ...
            function getEmployee() {
                ...
                var rank = $("select[id$='ddlRank']").val().trim();
                var status = $("select[id$='ddlStatus']").val().trim();
                var DateFrom = $("input[id$='txtFrom']").val().trim();
                var DateTo = $("input[id$='txtTo']").val().trim();
                $("input[id$='hdType']").val(Type);
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "../RMS/RMSwebmethods.aspx/getEmployeeNameWiseReport",
                    data: "{'Name':'" + Name + "','Type':'" + Type + "','CNIC':'" + CNIC + "','Rank':'" + rank + "','Status':'" + status + "','From':'" + DateFrom + "','To':'" + DateTo + "'}",
            ...
            function getEmployeeTable(data) {
                ...
                tbl += "<th style='white-space:nowrap; text-align:center;'>Photo</th>";
                ...
                for (var i = 0; i < data.EmployeeDetail.length; i++) {
                    ...
                    tbl += "<td style='text-align:left; white-space:nowrap;' id='txtDesignation" + i + "'>" + data.EmployeeDetail[i].Designation + " </td>";
                    ...
                    tbl += "<td style='text-align:left; white-space:nowrap;' id='txtModDate" + i + "'>" + data.EmployeeDetail[i].Status + " </td>";
                   // tbl += "<td style='text-align:left; white-space:nowrap;' id='txtCreatedBy" + i + "'><input style='width:60px;height:60px;' type='image' src='" + picDir + data.EmployeeDetail[i].Photo + ".jpg'></td>";
            ...
            function getNonResidentTable(data) {
                ...
                for (var i = 0; i < data.EmployeeDetail.length; i++) {
                    ...
                    //tbl += "<td style='white-space:nowrap; text-align:left;'>" + data.EmployeeDetail[i].RelName + "</td>";
                    ...
                    //tbl += "<td style='white-space:nowrap; text-align:left;'><input style='width:60px;height:60px;' type='image' src='" + picDir + data.EmployeeDetail[i].Photo + ".jpg'></td>";
            ...
            function getVMSVisitorTable(data) {
                ...
                for (var i = 0; i < data.EmployeeDetail.length; i++) {
                    tbl += "<tr id='trmain" + i + "' style='cursor:default;background-color:white;' >";
                    tbl += "<td style='text-align:left; white-space:nowrap; display:none;'>" + data.EmployeeDetail[i].ID + "</td>";
                    ...
                    //tbl += "<td style=' text-align:left;'>" + data.EmployeeDetail[i].Phone + "</td>";
                    //tbl += "<td style=' text-align:left;'>" + data.EmployeeDetail[i].Mobile + "</td>";
                    //tbl += "<td style=' text-align:left;'>" + data.EmployeeDetail[i].Addr + "</td>";
                    //tbl += "<td style=' text-align:left;'>" + data.EmployeeDetail[i].Profession + "</td>";
                    ...
                    //tbl += "<td style=' text-align:left;'>" + data.EmployeeDetail[i].IssueDt + "</td>";
                    //tbl += "<td style=' text-align:left;'>" + data.EmployeeDetail[i].ValidUpto + "</td>";
                    //tbl += "<td style=' text-align:left;'>" + data.EmployeeDetail[i].ReferenceName + "</td>";


                    //tbl += "<td style=' text-align:left;'>" + data.EmployeeDetail[i].Rank + "</td>";
                    //tbl += "<td style=' text-align:left;'>" + data.EmployeeDetail[i].Reference + "</td>";
            ...
            function onsuccessgetEmployeeSerant(msg) {
                ...
                for (var i = 0; i < data.EmployeeServantDetail.length; i++) {
                    ...
                    tbl += "<td style='text-align:left; white-space:nowrap;' id='txtModBy" + i + "'>" + data.EmployeeServantDetail[i].Status + " </td>";
                    tbl += "<td style='text-align:left; white-space:nowrap;' id='txtCreatedBy" + i + "'><input style='width:60px;height:60px;' type='image' src='../RMS/EmpPictures/EmpServantPicture/" + data.EmployeeServantDetail[i].Photo + ".jpg'></td>";
                    tbl += "</tr>";
            ...
            function getEmployeeServantFamilyDetails(msg) {
                ...
                for (var i = 0; i < data.EmployeeServantFamilyDetail.length; i++) {
                    ...
                    tbl += "<td style='text-align:left; white-space:nowrap;' id='txtModBy" + i + "'>" + data.EmployeeServantFamilyDetail[i].Status + " </td>";
                    tbl += "<td style='text-align:left; white-space:nowrap;' id='txtCreatedBy" + i + "'><input style='width:60px;height:60px;' type='image' src='../RMS/EmpPictures/EmpServantPicture/ServantFamilyPicture/" + data.EmployeeServantFamilyDetail[i].Photo + ".jpg'></td>";
                    tbl += "</tr>";
