<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="NameWiseReport.aspx.cs" Inherits="NameWiseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <fieldset style="width:95%;">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtName" placeholder="Enter minimum 3 characters" class="alpha"  runat="server" autocomplete="off"></asp:TextBox>
                <asp:HiddenField ID="hfCustomerId" runat="server" />
                <asp:HiddenField ID="ddlType" Value="1" runat="server" />
                 <div>
                    <ul id="testTable" style="background-color:black;color:wheat;">
    ...
    <script type="text/javascript" language="javascript">
            ...
            $("input[id$='txtName']").autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        ...
                        data: "{ 'Name':'" + Name + "','Type':'" + Type + "','CNIC':'','Rank':'','Status':''}",
                        dataType: "json",
                        type: "POST",
        ...
        function getEmployee() {
            ...
            $.ajax({
                ...
                data: "{'Name':'" + Name + "','Type':'" + Type + "','CNIC':'','Rank':'','Status':'','From':'','To':''}",
        ...
        function getEmployeeTable(data) {
            ...
            tbl += "<th style='white-space:nowrap; text-align:center;'>Detail</th>";
            tbl += "<th style='white-space:nowrap; text-align:center;'>Service No</th>";
            tbl += "<th style='white-space:nowrap; text-align:center;'>Name</th>";

            tbl += "<th style='white-space:nowrap; text-align:center;'>Rank</th>";
            tbl += "<th style='white-space:nowrap; text-align:center;'>NIC</th>";
            ...
            tbl += "<th style='white-space:nowrap; text-align:center;'>Department/Unit</th>";
            ...
            tbl += "<th style='white-space:nowrap; text-align:center;'>Status</th>";
            ...
            for (var i = 0; i < data.EmployeeDetail.length; i++) {
                ...
                tbl += "<td style='text-align:left; white-space:nowrap;' id='txtCreatedBy" + i + "'>" + data.EmployeeDetail[i].Status + "</td>";
        ...
        function getNonResidentTable(data) {
           ...
           // tbl += "<th style='white-space:nowrap; text-align:left;'>Relation Name</th>";
            ...
            //tbl += "<th style='white-space:nowrap; text-align:left;'>Current Address</th>";
            //tbl += "<th style='white-space:nowrap; text-align:left;'>Permanent Address</th>";
            tbl += "<th style='white-space:nowrap; text-align:left;'>Department/Unit</th>";
        ...
        function getVMSVisitorTable(data) {
            ...
            tbl += "<th style='text-align:left; white-space:nowrap; display:none;'>Employee ID</th>";
            //tbl += "<th style=' text-align:left;width:11%;'>Action </th>";
            ...
            for (var i = 0; i < data.EmployeeDetail.length; i++) {
                ...
                //tbl += "<td style=' text-align:left;'><span  id='VMSVisitorInActive"+i+"'style='cursor:pointer;' title='Inactive' onclick='InactiveVMSVisitor(" + data.EmployeeDetail[i].ID + ")'> <img src='../images/Cross2.png'/></span>   <span  id='ActivateVMSVisitor"+i+"'style='cursor:pointer;' title='Active' onclick='ActivateVMSVisitor(" + data.EmployeeDetail[i].ID + ")'> <img src='../images/Active.png'/></span>     <span  id='VMSVisitorBlackList"+i+"'style='cursor:pointer;' title='Black List' onclick='BlackListVMSVisitor(" + data.EmployeeDetail[i].ID + ")'> <img src='../images/Blacklist.png'/></span></td>";
                ...
                //tbl += "<td style='white-space:nowrap; text-align:left;'>" + data.EmployeeDetail[i].Rank + "</td>";
                //tbl += "<td style='white-space:nowrap; text-align:left;'>" + data.EmployeeDetail[i].Reference + "</td>";
                tbl += "<td style='text-align:left;' id='tdStatus"+i+"'>" + data.EmployeeDetail[i].Status + "</td>";
        ...
        function onsuccessgetEmployeeFamily(msg) {
           ...
           // tbl += "<th style='white-space:nowrap; text-align:left;'>Cell No</th>";
            ...
            for (var i = 0; i < data.EmployeeFamilyDetail.length; i++) {
                ...
                tbl += "<td style='text-align:right; white-space:nowrap;' id='txtModDate" + i + "'>" + data.EmployeeFamilyDetail[i].vpurpose + " </td>";
        ...
        function getEmployeeServantFamilyDetails(msg) {
            ...
            for (var i = 0; i < data.EmployeeServantFamilyDetail.length; i++) {
                ...
                tbl += "<td style='text-align:left; white-space:nowrap;' id='txtModDate" + i + "'>" + data.EmployeeServantFamilyDetail[i].Status + " </td>";
        ...
        function InactiveVMSVisitor(EID) {
        ...
        function ActivateVMSVisitor(EID) {
        ...
        function BlackListVMSVisitor(EID) {
