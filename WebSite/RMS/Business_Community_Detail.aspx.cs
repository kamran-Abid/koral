...
public partial class RMS_Business_Community_Detail : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataTable dtBusinessCommunityCategoryName = ObjCommon.GetBusinessCommunityCategory();
        ddlBusinessCommunityCategoryName.DataSource = dtBusinessCommunityCategoryName;
        ddlBusinessCommunityCategoryName.DataValueField = "ID";
        ddlBusinessCommunityCategoryName.DataTextField = "BusinessName";
        ddlBusinessCommunityCategoryName.DataBind();
        ddlBusinessCommunityCategoryName.Items.Insert(0, new ListItem("-- Select --", ""));

        DataTable dtBloodGroup = ObjCommon.BloodGroup();
    ...
    protected string UploadFolderPath = "~/RMS/BusinessCommunityDetailPictures/";
    protected void FileUploadComplete(object sender, EventArgs e)
    {
        ...
        if (txtCNIC.Value == "")
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Notify", "alert('Please enter CNIC First c#');", true);
            return;
