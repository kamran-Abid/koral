<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="EmployeeContractor.aspx.cs" Inherits="Report_Constractor_EmployeeContractor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <div>
    ...
    <fieldset>
        ...
        <LocalReport ReportPath="Report_Constractor/EmployeeContractorReport.rdlc">
        </LocalReport>
           ...
           $(document).ready(function () {
               ...
               $("#txtname").autocomplete({
                source: function (request, responce) {
                    ...
                    $.ajax({
                        url: "EmployeeContractor.aspx/GetEmployeeNames",
                        method: 'POST',
               ...
               $("#txtcnic").autocomplete({
                   source: function (request, responce) {
                       ...
                       $.ajax({
                           url: "EmployeeContractor.aspx/GetEmployeeCNIC",
                           method: 'POST',
                           data: JSON.stringify(terms),
                           contentType: "application/json;charset=utf-8",
                           dataType: 'json',
