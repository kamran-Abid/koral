...
public partial class Report_Constractor_ContractorReports : System.Web.UI.Page
{
    ...
    protected void btnsearch_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ds = db_Manager.ExecuteDataSet("Contractor_ReportS", "vmsconnectionstring");
            ReportViewer1.Visible = true;
            ReportDataSource rds = new ReportDataSource("ContractorReportDataSet", ds.Tables[0]);
    ...
    public static List<string> GetContractorNames(string term)
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("GetConstractorName_SP", con);
            ...
            while (rdr.Read())
            {
                listCountryName.Add(rdr["FirmName"].ToString());
            }
            con.Close();
    ...
    #region AutoComplet Contractor CNIC
    [WebMethod]
