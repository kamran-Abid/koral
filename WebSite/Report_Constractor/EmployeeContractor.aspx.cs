...
public partial class Report_Constractor_EmployeeContractor : System.Web.UI.Page
{
    ...
    protected void btnsearch_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ds = db_Manager.ExecuteDataSet("Employee_Report_Contractor", "vmsconnectionstring");
            ReportViewer1.Visible = true;
            ReportDataSource rds = new ReportDataSource("EmployeeContractorDataSet", ds.Tables[0]);
