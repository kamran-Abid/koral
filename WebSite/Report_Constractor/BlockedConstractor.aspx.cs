...
public partial class Report_Constractor_BlockedConstractor : System.Web.UI.Page
{
    ...
    protected void btnsearch_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ds = db_Manager.ExecuteDataSet("Block_Contractor_Reports", "vmsconnectionstring");
            ReportViewer1.Visible = true;
            ReportDataSource rds = new ReportDataSource("BlockedContractorDataSet", ds.Tables[0]);
