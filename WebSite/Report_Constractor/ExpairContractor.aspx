<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="ExpairContractor.aspx.cs" Inherits="Report_Constractor_ExpairContractor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
    <fieldset>
        <legend style="width:auto">Search Expired Date List Constractor criteria</legend>
        <div>
            <table>
    ...
    <fieldset>
        ...
        <LocalReport ReportPath="Report_Constractor/ExpairConstractorReport.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
        </div>
    </fieldset>
