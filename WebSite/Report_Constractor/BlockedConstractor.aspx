<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="BlockedConstractor.aspx.cs" Inherits="Report_Constractor_BlockedConstractor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
    <fieldset>
        <legend style="width:auto">Blocked List Constrator criteria</legend>
        <div>
            <table>
    ...
    <fieldset>
        ...
        <LocalReport ReportPath="Report_Constractor/BlockedReport.rdlc">
        </LocalReport>
