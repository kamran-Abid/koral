...
public partial class Report_Constractor_ExpairContractor : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ddDateFrom.Text = DateTime.Today.AddDays(-1).ToString("MM/dd/yyyy 00:00:00.000");
            ddDateTo.Text = DateTime.Today.ToString("MM/dd/yyyy 00:00:00.000");
    ...
    protected void btnsearch_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ds = db_Manager.ExecuteDataSet("Exp_COntrator_Reports", "vmsconnectionstring");
            ReportViewer1.Visible = true;
            ReportDataSource rds = new ReportDataSource("ExpairconstractorDataSet", ds.Tables[0]);
