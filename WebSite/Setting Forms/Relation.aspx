<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="Relation.aspx.cs" Inherits="Setting_Forms_Relation" %>
      ...
      function SaveRelation()
      {
          ...
          for (i = 0; i < $("#tblRelationDetails tr").length - 1; i++)
          {
              ...
              if ($("#txtRelationName" + i).html().toUpperCase().trim() == $("input[id$='txtRelationName']").val().toUpperCase().trim()) {
                  alert("Relationship " + $("input[id$='txtRelationName']").val() + " is already added!");
