<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="AddCaste.aspx.cs" Inherits="AddCaste" %>
    ...
    <script type="text/javascript" language="javascript">
            ...
            if ($("#tbleCasteDetails tr").length - 1 > 1) {
                for (i = 0; i < $("#tbleCasteDetails tr").length - 1; i++) {
                    ...
                    if ($("#txtCasteName" + i).html().toUpperCase().trim() == $("input[id$='txtCasteName']").val().toUpperCase().trim()) {
                        alert("Caste " + $("input[id$='txtCasteName']").val() + " is already added!");
        ...
        function onsuccessgetCaste(msg) {
            ...
            for (var i = 0; i < data.CasteDetail.length; i++) {
                ...
                tbl += "<td style='text-align:right; white-space:nowrap; display:none;' id='txtID" + i + "'>" + data.CasteDetail[i].Caste_ID + "</td>";

                tbl += "<td style='text-align:left; white-space:nowrap;' id='txtCasteName" + i + "'>" + data.CasteDetail[i].Caste_Name + "</td>";
