<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="AddReligion.aspx.cs" Inherits="AddReligion" %>
          ...
          if ($("#tblReligionDetails tr").length - 1 > 1) {
              for (i = 0; i < $("#tblReligionDetails tr").length - 1; i++) {
                  ...
                  if ($("#txtReligionName" + i).html().toUpperCase().trim() == $("input[id$='txtReligionName']").val().toUpperCase().trim()) {
                      alert("Religion " + $("input[id$='txtReligionName']").val() + " is already added!");
