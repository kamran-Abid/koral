<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="AddDepartment.aspx.cs" Inherits="AddDepartment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       ...
       <table style="width:100%;margin-top:0%;vertical-align:top;">
        ...
        <tr>
            <td>
               <fieldset>
                   <legend>Add/Modified Department/Unit</legend>
               
                    <table  style="font-family: Calibri; font-size: 11pt;width:100%;" >
                    <tr>
                        <td style="width:140px;text-align:left;">
                            <asp:Label ID="lblDepartmentName" Text="Department/Unit Name:" runat="server"></asp:Label>
                        </td>
     ...
     <div id="divGetDepartmentDetails"  >
            <fieldset id="fldGetDepartmentDetails" >
                <legend>Departments/Unit Details</legend>
    ...
    $(document).ready(function () {
      ...
      function SaveDepartment()
      {
          ...
          if (Department_Name == "")
            {
                alert("Please Enter Department/Unit Name!");
                return false;
        }
      ...
      function onsuccessgetDepartment(msg)
      {
        ...
        if(oTable !=null)
          ...
          var tbl = "";
                ...
                tbl += "<th style='white-space:nowrap; text-align:left;'>Department/Unit Name</th>";
