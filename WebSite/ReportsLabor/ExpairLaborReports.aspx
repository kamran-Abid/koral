<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="ExpairLaborReports.aspx.cs" Inherits="RepotrsLabor_ExpairLaborReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
    <fieldset>
        <legend style="width:auto">Search Expired Date List Labor Constractor criteria</legend>
        <div>
            <table>
    ...
    <fieldset>
        ...
        <LocalReport ReportPath="ReportsLabor/ExpairLaborReport.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
        </div>
    </fieldset>
