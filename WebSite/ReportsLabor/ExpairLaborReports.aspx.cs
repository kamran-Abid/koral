...
public partial class RepotrsLabor_ExpairLaborReports : System.Web.UI.Page
{
    ...
    DBManager db_Manager = new DBManager();
        ...
        try
        {
            ...
            ds = db_Manager.ExecuteDataSet("Exp_Labor_Report", "vmsconnectionstring");
            ReportViewer1.Visible = true;
            ReportDataSource rds = new ReportDataSource("ExpairlaborDataSet", ds.Tables[0]);
