<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="LaborEmployee.aspx.cs" Inherits="RepotrsLabor_LaborEmployee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <div>
    ...
    <fieldset>
        ...
        <LocalReport ReportPath="ReportsLabor/LaborEmployeeReport.rdlc">
        </LocalReport>
           ...
           $(document).ready(function () {
               ...
               $("#txtname").autocomplete({
                source: function (request, responce) {
                    ...
                    $.ajax({
                        url: "LaborEmployee.aspx/GetEmployeeNames",
                        method: 'POST',
               ...
               $("#txtcnic").autocomplete({
                   source: function (request, responce) {
                       ...
                       $.ajax({
                           url: "LaborEmployee.aspx/GetEmployeeCNIC",
                           method: 'POST',
                           data: JSON.stringify(terms),
                           contentType: "application/json;charset=utf-8",
                           dataType: 'json',
