<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="LaborReports.aspx.cs" Inherits="RepotrsLabor_LaborReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
    <fieldset>
        <legend style="width:auto">Search Labor Contractor criteria</legend>
        <div>
            <table>
                <tr>
                    <td>Labor Name:</td>
    ...
    <fieldset>
        ...
        <LocalReport ReportPath="ReportsLabor/LaborReport.rdlc">
        </LocalReport>
           ...
           $(document).ready(function () {
               ...
               $("#txtname").autocomplete({
                   source: function (request, responce) {
                       ...
                       $.ajax({
                           url: "LaborReports.aspx/GetLaborNames",
                           method: 'POST',
               ...
               $("#txtcnic").autocomplete({
                   source: function (request, responce) {
                       ...
                       $.ajax({
                           url: "LaborReports.aspx/GetLaborCNIC",
                           method: 'POST',
                           data: JSON.stringify(terms),
                           contentType: "application/json;charset=utf-8",
                           dataType: 'json',
