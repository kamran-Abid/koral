<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="ConstractorReport.aspx.cs" Inherits="ConstructorReport_ConstractorReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                    ...
                    <table>
                        ...
                        <rjs:popcalendar ID="Popcalendar1" Separator="/" Format="mm dd yyyy" Control="DDateFrom" runat="server"
                                Font-Names="Tahoma" />
                                  ...
                                  <td>Frim Name</td>
                             <td>
                                 <asp:TextBox ID="txtcrFirmName" runat="server"></asp:TextBox>
                        ...
                        <rjs:popcalendar ID="Popcalendar2" Separator="/" Format="mm dd yyyy" Control="DDateTo" runat="server"
                             ...
                             <td >
                                 <asp:Button ID="GetBusnesCommunityReport" CssClass="btn btn-primary buttons" runat="server" Text="Search" OnClick="GetConstractorReport_Click" /> </td>
    ...
    <fieldset>
        ...
        <LocalReport ReportPath="ConstructorReport\ConstracorRpt.rdlc">
        </LocalReport>
