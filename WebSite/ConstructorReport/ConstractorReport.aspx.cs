...
public partial class ConstructorReport_ConstractorReport : System.Web.UI.Page
{
    ...
    protected void GetConstractorReport_Click(object sender, EventArgs e)
    {
        ...
        string FrimName = txtcrFirmName.Text;
        ...
        ConstractorLoadReport(Name, Gender, SiteAllow, ClearnceAllow, FrimName, DateFrom, DateTo);



    }
    public void ConstractorLoadReport(string Name, string Gender, string SiteAllow, string ClearnceAllow, string FrimName, string DateFrom, string DateTo)
    {
        ...
        try
        {
            ...
            db_Manager.AddParameterReport("@crFirmName", FrimName);
            db_Manager.AddParameterReport("@FromDate", DateFrom);
            db_Manager.AddParameterReport("@ToDate", DateTo);
            ds = db_Manager.ExecuteDataSet("Constractor_Report", "vmsconnectionstring");
            ReportViewer1.Visible = true;
            ReportDataSource rds = new ReportDataSource("ConstructorDataSet", ds.Tables[0]);
