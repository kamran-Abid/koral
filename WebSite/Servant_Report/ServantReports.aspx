<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="ServantReports.aspx.cs" Inherits="Servant_Report_ServantReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <fieldset>
            <legend>Servant Search Criteria</legend>
              <div class="container">
                  <div class="row">
                    <table>
                        <tr>
                        ...
                        <rjs:popcalendar ID="Popcalendar1" Separator="/" Format="mm dd yyyy" Control="DDateFrom" runat="server"
                             ...
                             <td>
                                  ...
                                  <asp:TextBox ID="txtbcnumber" runat="server"></asp:TextBox>
                             </td>
                        ...
                        <rjs:popcalendar ID="Popcalendar2" Separator="/" Format="mm dd yyyy" Control="DDateTo" runat="server"
                             ...
                             <td >
                                 <asp:Button ID="GetBusnesCommunityReport" CssClass="btn btn-primary buttons" runat="server" Text="Search" OnClick="GetServantReport_Click" /> </td>
    ...
    <fieldset>
        ...
        <LocalReport ReportPath="Servant_Report\ServantReport.rdlc">
        </LocalReport>
