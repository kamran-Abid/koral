...
public class DBManager
{
    ...
    public SqlDataReader DataReader(string procedureName, string strConn)
    {
    ...
    #region----Report Parameter Set
    public void AddParameterReport(string paramerterName , object value)
    {
        SqlParameter parameter = new SqlParameter { SqlValue = (object)value ?? DBNull.Value, ParameterName = paramerterName };
        Parameters.Add(parameter);
    }
    #endregion
    ...
    public int ExecuteDataTableIDOut(string procedureName, string strConn)
    {
        ...
        try
        {
            ...
            spm.ParameterName = "@SlipNo";
            spm.Direction = ParameterDirection.Output;
            //spm.Size  = 4;
            spm.DbType = DbType.Int32;
            
            _SqlCommand.Parameters.Add(spm);
            _SqlCommand.CommandType = CommandType.StoredProcedure;
            int ss = _SqlCommand.ExecuteNonQuery();
           int ID = (int)_SqlCommand.Parameters["@SlipNo"].Value;
