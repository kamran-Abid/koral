<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="BussinessCommunityReport.aspx.cs" Inherits="BussinessCommunityReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <fieldset>
            <legend>Business Community Search Criteria</legend>
              <div class="container">
                  <div class="row">
                    <table>
                        <tr>
                        ...
                        <rjs:popcalendar ID="Popcalendar1" Separator="/" Format="mm dd yyyy" Control="DDateFrom" runat="server"
                             ...
                             <td>
                                 <asp:DropDownList style="width:300px" CssClass="form-control textboxSize" ID="ddlBusinessCategory" runat="server"></asp:DropDownList>
                        ...
                        <rjs:popcalendar ID="Popcalendar2" Separator="/" Format="mm dd yyyy" Control="DDateTo" runat="server"
                             ...
                             <td >
                                 <asp:Button ID="GetBusnesCommunityReport" CssClass="btn btn-primary buttons" runat="server" Text="Search" OnClick="GetBusnesCommunityReport_Click" /> </td>
    ...
    <fieldset>
        <legend> Business Community Report</legend>
        ...
        <LocalReport ReportPath="BusinessCommunityReport\BussinessCommunityReports.rdlc">
        </LocalReport>
