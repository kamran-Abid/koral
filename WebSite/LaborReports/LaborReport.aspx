<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="LaborReport.aspx.cs" Inherits="LaborReports_LaborReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                  ...
                  <div class="row">
                    <table>
                        ...
                        <rjs:popcalendar ID="Popcalendar2" Separator="/" Format="mm dd yyyy" Control="DDateTo" runat="server"
                             ...
                             <td >
                                 <asp:Button ID="GetLaborReport" CssClass="btn btn-primary buttons" runat="server" Text="Search" OnClick="GetLaborReport_Click" /> </td>
    ...
    <fieldset>
        ...
        <LocalReport ReportPath="LaborReports\LaborReport.rdlc">
        </LocalReport>
