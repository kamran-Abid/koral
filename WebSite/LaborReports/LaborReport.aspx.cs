...
public partial class LaborReports_LaborReport : System.Web.UI.Page
{
    ...
    protected void GetLaborReport_Click(object sender, EventArgs e)
    {
    ...
    public void ConstractorLoadReport(string Name, string Gender, string SiteAllow, string ClearnceAllow, string FrimName, string DateFrom, string DateTo)
    {
        ...
        try
        {
            ...
            ReportDataSource rds = new ReportDataSource("LaborDataSet", ds.Tables[0]);
