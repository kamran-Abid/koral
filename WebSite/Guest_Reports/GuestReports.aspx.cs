...
public partial class Guest_Reports_GuestReports : System.Web.UI.Page
{
    ...
    protected void GetGuestReport_Click(object sender, EventArgs e)
    {
        ...
        ServantLoadReport(Name, cnic, SiteAllow, ClearnceAllow, DateFrom, DateTo);




    }
    public void ServantLoadReport(string Name, string cnic, string SiteAllow, string ClearnceAllow, string DateFrom, string DateTo)
    {
        ...
        try
        {
            ...
            ds = db_Manager.ExecuteDataSet("Guest_Report", "vmsconnectionstring");
            ReportViewer1.Visible = true;
            ReportDataSource rds = new ReportDataSource("GuestReportDataSet", ds.Tables[0]);
