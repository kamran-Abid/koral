<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="GuestReports.aspx.cs" Inherits="Guest_Reports_GuestReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <fieldset>
            <legend>Guest Search Criteria</legend>
              <div class="container">
                  <div class="row">
                    <table>
                        <tr>
                        ...
                        <rjs:popcalendar ID="Popcalendar2" Separator="/" Format="mm dd yyyy" Control="DDateTo" runat="server"
                             ...
                             <td >
                                 <asp:Button ID="GetBusnesCommunityReport" CssClass="btn btn-primary buttons" runat="server" Text="Search" OnClick="GetGuestReport_Click" /> </td>
    ...
    <fieldset>
        ...
        <LocalReport ReportPath="Guest_Reports\GuestReport.rdlc">
        </LocalReport>
