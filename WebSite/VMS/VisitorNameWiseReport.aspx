<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="VisitorNameWiseReport.aspx.cs" Inherits="VisitorNameWiseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <fieldset style="width:95%;">
        <legend>Visitor Name Wise Search Criteria</legend>
        <div  >
        <table id="tblCNICWiseReport" class="form">
        <tr>
            <td class="right">Enter Visitor Name:</td>
            <td >
                <asp:TextBox ID="txtVisitorName" class="alpha" runat="server"></asp:TextBox>
            </td>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function getVisitor() {
            //if (!validate("tblCNICWiseReport")) {
                var VisitorName = $("input[id$='txtVisitorName']").val().trim();
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "../VMS/webmethods.aspx/getVisitorNameWiseReport",
