<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="BlackList_Visitor.aspx.cs" Inherits="Reposts_GuestReports_BlackList_Visitor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
    <fieldset>
        <legend style="width:auto">Blocked Visitor criteria</legend>
        <div>
            <table>
    ...
    <fieldset>
        ...
        <LocalReport ReportPath="Report_Guest/BlockedReport.rdlc">
        </LocalReport>
