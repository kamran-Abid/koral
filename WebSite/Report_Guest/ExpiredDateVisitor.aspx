<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="ExpiredDateVisitor.aspx.cs" Inherits="Reposts_GuestReports_ExpiredDateVisitor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
    <fieldset>
        <legend style="width:auto">Search Expired Date Visitor criteria</legend>
        <div>
            <table>
    ...
    <fieldset>
        ...
        <LocalReport ReportPath="Report_Guest/ExpairedVisitorReport.rdlc">
        </LocalReport>
