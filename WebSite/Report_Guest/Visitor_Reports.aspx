<%@ Page Title="" Language="C#" MasterPageFile="~/PACS.master" AutoEventWireup="true" CodeFile="Visitor_Reports.aspx.cs" Inherits="Reposts_GuestReports_Visitor_Reports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <div>
    <fieldset>
        <legend style="width:auto">Search Vistor criteria</legend>
        <div>
            <table>
                <tr>
                    <td>Visitor Name:</td>
    ...
    <fieldset>
        ...
        <LocalReport ReportPath="Report_Guest/VisitorReport.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
        </div>
    </fieldset>
           ...
           $(document).ready(function () {
               ...
               $("#txtname").autocomplete({
                   source: function (request, responce) {
                       ...
                       $.ajax({
                           url: "Visitor_Reports.aspx/GetVisitorNames",//need a changehere after comparing to hGR
                           method: 'POST',
               ...
               $("#txtcnic").autocomplete({
                   source: function (request, responce) {
                       ...
                       $.ajax({
                           url: "Visitor_Reports.aspx/GetVisitorCNIC",
                           method: 'POST',
                           data: JSON.stringify(terms),
                           contentType: "application/json;charset=utf-8",
                           dataType: 'json',
