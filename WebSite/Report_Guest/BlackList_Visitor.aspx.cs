...
public partial class Reposts_GuestReports_BlackList_Visitor : System.Web.UI.Page
{
    ...
    protected void btnsearch_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ds = db_Manager.ExecuteDataSet("Block_Guest_Reports", "vmsconnectionstring");
            ReportViewer1.Visible = true;
            ReportDataSource rds = new ReportDataSource("BlocklistDataSet", ds.Tables[0]);
