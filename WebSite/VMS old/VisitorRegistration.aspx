    ...
    <script type="text/javascript">
        ...
        function onSucceed(results, currentContext, methodName) {
           ...
           // $("input[id$='txtUFamilyNo']").val(arry[2]);
            ...
            $("textarea[id$='txtAddress']").val(arry[6] + arry[7]);
        ...
        function getCurrentTime() {
          ...
          <fieldset id="fldSetVisterReg" style="width:97%; ">
    ...
    <table id="tblVisitorReg" style="font-family: Calibri; font-size: 11pt; width: 100%;">
        <tr>
             <td rowspan="13" style="vertical-align: top;width:300px; text-align:center;">
                <fieldset id="fldLastVisit">
                    <legend>Last Visit</legend>
               
                                                    <asp:Image ID="Image1" runat="server" Height="96px" Width="104px" BorderColor="#003366"
        ...
        <tr>
            ...
            <td style="width: 500px; white-space:nowrap;">
                <asp:TextBox ID="txtDateOfBirth" style="width: 82%;float: left;margin-right: 2%;"  class="req" runat="server" ></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtAddress"  runat="server" TextMode="MultiLine" style="text-align:right" BackColor="White" Height="55px" Width="341px"></asp:TextBox>
            </td>
        </tr>
        ...
        <fieldset id="fldVisitorDetails" style="overflow: auto; width:80%; ">
